...
**菜单暴露情况**: 当前侧边栏菜单仅暴露 **4 个入口**（安全检查、隐患排查、事故管理、安全培训）。其余 **12 个功能模块** 需通过直接输入 URL 访问。
...
**截图**: 08-hazard-identification.png
...
|------|---------|------|------|
| 1 | 仪表盘首页 | /safety | 已移植 |
| 2 | 安全检查 | /safety/check | 已移植 |
| 3 | 隐患排查 | /safety/hazard | 已移植 |
| 4 | 隐患台账 | /safety/hazard-ledger | 已移植 |
| 5 | 事故管理 | /safety/accident | 已移植 |
| 6 | 安全培训 | /safety/training | 已移植 |
| 7 | 特殊作业 | /safety/special-ops | 已移植 |
| 8 | 危险源辨识 | /safety/hazard-identification | 已移植 |
| 9 | 定时任务 | /safety/scheduled-tasks | 已移植 |
| 10 | 承包商管理 | /safety/contractor | 已移植 |
| 11 | 安全知识库 | /safety/knowledge-base | 已移植 |
| 12 | 职业健康 | /safety/occupational-health | 已移植 |
| 13 | EHS变更 | /safety/ehs-change | 已移植 |
| 14 | 法规管理 | /safety/regulation | 已移植 |
| 15 | 风险报备 | /safety/risk-reporting | 已移植 |
| 16 | AI工作流配置 | /safety/ai-workflow-config | 已移植 |
...
**补充说明**: 另有隐患详情页、危险源辨识新建/台账/详情、定时任务新建/详情、法规生成器等动态路由页面已移植但未单独截图展示。
