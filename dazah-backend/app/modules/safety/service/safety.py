...
async def _send_verify_notification(hazard: HazardReport, level: int) -> None:
    ...
    async def _export_hazard_ledger_pdf_fallback(
        ...
        # 跨平台 CJK 字体候选：Windows + 常见 Linux 字体路径
        # 注册成功的第一个常规/粗体字体生效；全部失败时优雅回退 Helvetica（中文可能缺字）
        _chinese_fonts = [
            ("C:/Windows/Fonts/simsun.ttc", "SimSun"),
            ("C:/Windows/Fonts/simhei.ttf", "SimHei"),
            ("C:/Windows/Fonts/msyh.ttc", "MicrosoftYaHei"),
            ("/usr/share/fonts/truetype/wqy/wqy-zenhei.ttc", "SimSun"),
            ("/usr/share/fonts/truetype/wqy/wqy-microhei.ttc", "SimHei"),
            ("/usr/share/fonts/opentype/noto/NotoSansCJK-Regular.ttc", "SimSun"),
            ("/usr/share/fonts/truetype/noto/NotoSansCJK-Regular.ttc", "SimSun"),
            ("/usr/share/fonts/truetype/arphic/uming.ttc", "SimSun"),
        ]
