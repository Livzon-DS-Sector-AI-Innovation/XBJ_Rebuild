...
import type { InspectionTemplate as InspectionTemplateType } from '@/types/inspection'
                  ...
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <Select
                        ...
                        optionFilterProp="label" options={locOptions}
                      />
                    </div>
                    <div style={{ width: 80 }}>
                      <div style={{ fontSize: 11, fontWeight: 600, color: C.stone, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>
                    ...
                    <div key={eq.key} style={{
                      ...
                      <div style={{ padding: '10px 14px', display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <Select
                            ...
                            optionFilterProp="label" options={eqOptions}
                          />
                          {eq.equipment_name && (
                      ...
                      <div style={{
                        ...
                        <Select
                          ...
                          optionFilterProp="label" options={tplOptions}
                        />
                      </div>
                    </div>
                  ))}
