...
import { AdminChatState } from '@/stores/createAdminChatStore'

const { TextArea } = Input

interface SmartAssistantProps {
  store: AdminChatState
            ...
            return (
              ...
              >
                ...
                <div className="max-w-[85%] space-y-1">
                  {msg.role === 'assistant' && (thinking || isThinking || msg.reasoning_content) && (
                    <div className="rounded-md bg-amber-50 border border-amber-100 px-2 py-1.5">
                      <div className="flex items-center gap-1 text-amber-600 text-xs font-medium mb-0.5">
                        <BulbOutlined />
                        {isThinking || (isLastAssistant && isLoading && !msg.content)
                          ? '正在思考...'
                          : '思考过程'}
                      </div>
